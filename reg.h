...
_regs_ BF_9(UINT RX_EN : 1 ,UINT _rev0 : 8, UINT RX_RCKEDGE : 1 ,UINT RX_DATTYPE : 2 ,UINT RX_RCKDLY : 4 ,UINT RX_ERTYPE : 2 ,UINT RX_RMII10 : 1 ,UINT _rev1 : 4, UINT _rev2 : 9 ) _rege_ _ETH_12;
_regs_ BF_14(UINT TX_DATBIT : 1 ,UINT TX_DATTYPE : 1 ,UINT TX_CLKOE : 1 ,UINT TX_CLKEDGE : 1 ,UINT TX_CLKSEL : 1 ,UINT TX_CRSCHK : 1 ,UINT TX_COLCHK : 1 ,UINT TX_COLSEL : 1 ,UINT TX_PAUSE_EN : 1 ,UINT TX_PAUSE : 1 ,UINT _rev0 : 11, UINT _rev1 : 9 ,UINT TX_COLEN : 1 ,UINT TX_RMII10 : 1 ) _rege_ _ETH_13;
...
_regs_ BF_12(UINT RST_RID : 4 ,UINT _rev0 : 14, UINT RST_PERI_REG : 1 ,UINT RST_H265_REG : 1 ,UINT MCU_PHY_RST : 1 ,UINT RST_NPU_REG : 1 ,UINT RST_CPU3 : 1 ,UINT RST_CPU2 : 1 ,UINT RST_CPU1 : 1 ,UINT RST_CPU0 : 1 ,UINT RST_ISP : 1 , UINT _rev1 : 5 ) _rege_ _SYS_0;
...
_regs_ BF_15(UINT _rev0 : 10, UINT EVENT_SOURCE_SEL : 1 ,UINT CNT2_EVENT_SEL : 2 ,UINT CNT1_EVENT_SEL : 1 ,UINT CNT_SEL1 : 2 ,UINT SEL05 : 2 ,UINT SEL04 : 2 ,UINT SEL03 : 2 ,UINT SEL02 : 2 ,UINT SEL01 : 2 ,UINT SEL00 : 2 ,UINT INTERUPT_ENABLE : 1 ,UINT TRIGGER_ENABLE : 1 ,UINT CNT_START : 1 ,UINT CNT_ENABLE : 1 ) _rege_ _OIC_S00_0;
_regs_ BF_1(UINT TRIGGER_VAL1 : 32 ) _rege_ _OIC_S00_4;
_regs_ BF_1(UINT TRIGGER_VAL2 : 32 ) _rege_ _OIC_S00_8;
_regs_ BF_6(UINT _rev0 : 9, UINT EVENT_PAYLOAD : 14 ,UINT OVERFLOW_FLAG : 6 ,UINT INTERRUPT_OCCUR : 1 ,UINT TRIGGER_OCCUR : 1 ,UINT CNT_STOP : 1 ) _rege_ _OIC_S00_C;
_regs_ BF_1(UINT CNT0 : 32 ) _rege_ _OIC_S00_10;
_regs_ BF_1(UINT CNT1 : 32 ) _rege_ _OIC_S00_14;
_regs_ BF_1(UINT CNT2 : 32 ) _rege_ _OIC_S00_18;
_regs_ BF_1(UINT CNT3 : 32 ) _rege_ _OIC_S00_1C;
_regs_ BF_1(UINT CNT4 : 32 ) _rege_ _OIC_S00_20;
_regs_ BF_1(UINT CNT5 : 32 ) _rege_ _OIC_S00_24;
_regs_ BF_7(UINT _rev0 : 12, UINT SEL5 : 4 ,UINT SEL4 : 4 ,UINT SEL3 : 4 ,UINT SEL2 : 3 ,UINT _rev1 : 1, UINT SEL1 : 4 ) _rege_ _OIC_S00_F000;
_regs_ BF_2(UINT _rev0 : 22, UINT ID_MASK : 10 ) _rege_ _OIC_S00_F004;
_regs_ BF_2(UINT _rev0 : 22, UINT ID_VALUE : 10 ) _rege_ _OIC_S00_F008;
_regs_ BF_2(UINT _rev0 : 31, UINT FILTER_IS_UPDATED : 1 ) _rege_ _OIC_S00_F00C;
_regs_ BF_3(UINT IS_INT_LOG_CR_FLAG : 1 ,UINT _rev0 : 21, UINT NUM_OF_INTERRUPT : 10 ) _rege_ _OIC_ITRP_0;
_regs_ BF_2(UINT _rev0 : 10, UINT INT_BIT_VECTOR : 22 ) _rege_ _OIC_ITRP_4;
_regs_ BF_2(UINT _rev0 : 10, UINT INT_CLEAR : 22 ) _rege_ _OIC_ITRP_84;
_regs_ BF_2(UINT _rev0 : 10, UINT INT_MASK : 22 ) _rege_ _OIC_ITRP_104;
...
#define ETH_RX_LTC _bm(_ETH_98,REG_BASE_ETH, (98<<3),RX_LTC) // 9 Bit, 9'h0, RW
#define ETH_TX_GO_LTC _bm(_ETH_99,REG_BASE_ETH, (99<<3),TX_GO_LTC) // 9 Bit, 9'h0, RW
#define ETH_TX_LTC _bm(_ETH_100,REG_BASE_ETH, (100<<3),TX_LTC) // 9 Bit, 9'h0, RW
...
#define SYS_RST_PERI_REG _bm(_SYS_0,REG_BASE_SYS, (0<<3),RST_PERI_REG) // 1 Bit, 1'h0, RW
#define SYS_RST_H265_REG _bm(_SYS_0,REG_BASE_SYS, (0<<3),RST_H265_REG) // 1 Bit, 1'h0, RW
#define SYS_MCU_PHY_RST _bm(_SYS_0,REG_BASE_SYS, (0<<3),MCU_PHY_RST) // 1 Bit, 1'h0, RW
#define SYS_RST_NPU_REG _bm(_SYS_0,REG_BASE_SYS, (0<<3),RST_NPU_REG) // 1 Bit, 1'h0, RW
...
#define SYS_NPU_PD _bm(_SYS_1,REG_BASE_SYS, (1<<3),NPU_PD) // 1 Bit, 1'h0, RW
#define SYS_CPU3_PD _bm(_SYS_1,REG_BASE_SYS, (1<<3),CPU3_PD) // 1 Bit, 1'h0, RW
#define SYS_CPU2_PD _bm(_SYS_1,REG_BASE_SYS, (1<<3),CPU2_PD) // 1 Bit, 1'h0, RW
#define SYS_CPU1_PD _bm(_SYS_1,REG_BASE_SYS, (1<<3),CPU1_PD) // 1 Bit, 1'h0, RW
#define SYS_CPU0_PD _bm(_SYS_1,REG_BASE_SYS, (1<<3),CPU0_PD) // 1 Bit, 1'h0, RW
...
#define IRQ_G_ISP _bm(_IRQ_0,REG_BASE_IRQ, (0<<3),G_ISP) // 1 Bit, 1'h0, R
...
#define OIC_S00_EVENT_SOURCE_SEL _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),EVENT_SOURCE_SEL) // 1 Bit, 1'h0, RW
#define OIC_S00_CNT2_EVENT_SEL _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),CNT2_EVENT_SEL) // 2 Bit, 2'h0, RW
#define OIC_S00_CNT1_EVENT_SEL _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),CNT1_EVENT_SEL) // 1 Bit, 1'h0, RW
#define OIC_S00_CNT_SEL1 _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),CNT_SEL1) // 2 Bit, 2'h0, RW
#define OIC_S00_SEL05 _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),SEL05) // 2 Bit, 2'h0, RW
#define OIC_S00_SEL04 _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),SEL04) // 2 Bit, 2'h0, RW
#define OIC_S00_SEL03 _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),SEL03) // 2 Bit, 2'h0, RW
#define OIC_S00_SEL02 _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),SEL02) // 2 Bit, 2'h0, RW
#define OIC_S00_SEL01 _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),SEL01) // 2 Bit, 2'h0, RW
#define OIC_S00_SEL00 _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),SEL00) // 2 Bit, 2'h0, RW
#define OIC_S00_INTERUPT_ENABLE _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),INTERUPT_ENABLE) // 1 Bit, 1'h0, RW
#define OIC_S00_TRIGGER_ENABLE _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),TRIGGER_ENABLE) // 1 Bit, 1'h0, RW
#define OIC_S00_CNT_START _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),CNT_START) // 1 Bit, 1'h0, RW
#define OIC_S00_CNT_ENABLE _bm(_OIC_S00_0,REG_BASE_OIC_S00, (0x0),CNT_ENABLE) // 1 Bit, 1'h0, RW
#define OIC_S00_TRIGGER_VAL1 _bm(_OIC_S00_4,REG_BASE_OIC_S00, (0x4),TRIGGER_VAL1) // 32 Bit, 32'h0, RW
#define OIC_S00_TRIGGER_VAL2 _bm(_OIC_S00_8,REG_BASE_OIC_S00, (0x8),TRIGGER_VAL2) // 32 Bit, 32'h0, RW
#define OIC_S00_EVENT_PAYLOAD _bm(_OIC_S00_C,REG_BASE_OIC_S00, (0xC),EVENT_PAYLOAD) // 14 Bit, 14'h0, R
#define OIC_S00_OVERFLOW_FLAG _bm(_OIC_S00_C,REG_BASE_OIC_S00, (0xC),OVERFLOW_FLAG) // 6 Bit, 6'h0, R
#define OIC_S00_INTERRUPT_OCCUR _bm(_OIC_S00_C,REG_BASE_OIC_S00, (0xC),INTERRUPT_OCCUR) // 1 Bit, 1'h0, R
#define OIC_S00_TRIGGER_OCCUR _bm(_OIC_S00_C,REG_BASE_OIC_S00, (0xC),TRIGGER_OCCUR) // 1 Bit, 1'h0, R
#define OIC_S00_CNT_STOP _bm(_OIC_S00_C,REG_BASE_OIC_S00, (0xC),CNT_STOP) // 1 Bit, 1'h0, R
#define OIC_S00_CNT0 _bm(_OIC_S00_10,REG_BASE_OIC_S00, (0x10),CNT0) // 32 Bit, 32'h0, R
#define OIC_S00_CNT1 _bm(_OIC_S00_14,REG_BASE_OIC_S00, (0x14),CNT1) // 32 Bit, 32'h0, R
#define OIC_S00_CNT2 _bm(_OIC_S00_18,REG_BASE_OIC_S00, (0x18),CNT2) // 32 Bit, 32'h0, R
#define OIC_S00_CNT3 _bm(_OIC_S00_1C,REG_BASE_OIC_S00, (0x1C),CNT3) // 32 Bit, 32'h0, R
#define OIC_S00_CNT4 _bm(_OIC_S00_20,REG_BASE_OIC_S00, (0x20),CNT4) // 32 Bit, 32'h0, R
#define OIC_S00_CNT5 _bm(_OIC_S00_24,REG_BASE_OIC_S00, (0x24),CNT5) // 32 Bit, 32'h0, R
#define OIC_S00_SEL5 _bm(_OIC_S00_F000,REG_BASE_OIC_S00, (0xF000),SEL5) // 4 Bit, 4'h0, R
#define OIC_S00_SEL4 _bm(_OIC_S00_F000,REG_BASE_OIC_S00, (0xF000),SEL4) // 4 Bit, 4'h0, R
#define OIC_S00_SEL3 _bm(_OIC_S00_F000,REG_BASE_OIC_S00, (0xF000),SEL3) // 4 Bit, 4'h0, R
#define OIC_S00_SEL2 _bm(_OIC_S00_F000,REG_BASE_OIC_S00, (0xF000),SEL2) // 3 Bit, 4'h0, R
#define OIC_S00_SEL1 _bm(_OIC_S00_F000,REG_BASE_OIC_S00, (0xF000),SEL1) // 4 Bit, 4'h0, R
#define OIC_S00_ID_MASK _bm(_OIC_S00_F004,REG_BASE_OIC_S00, (0xF004),ID_MASK) // 10 Bit, 10'h0, RW
#define OIC_S00_ID_VALUE _bm(_OIC_S00_F008,REG_BASE_OIC_S00, (0xF008),ID_VALUE) // 10 Bit, 10'h0, RW
#define OIC_S00_FILTER_IS_UPDATED _bm(_OIC_S00_F00C,REG_BASE_OIC_S00, (0xF00C),FILTER_IS_UPDATED) // 1 Bit, 1'h0, R
#define OIC_ITRP_IS_INT_LOG_CR_FLAG _bm(_OIC_ITRP_0,REG_BASE_OIC_ITRP, (0x0),IS_INT_LOG_CR_FLAG) // 1 Bit, 1'h0, R
#define OIC_ITRP_NUM_OF_INTERRUPT _bm(_OIC_ITRP_0,REG_BASE_OIC_ITRP, (0x0),NUM_OF_INTERRUPT) // 10 Bit, 10'h16, R
#define OIC_ITRP_INT_BIT_VECTOR _bm(_OIC_ITRP_4,REG_BASE_OIC_ITRP, (0x4),INT_BIT_VECTOR) // 22 Bit, 22'h0, R
#define OIC_ITRP_INT_CLEAR _bm(_OIC_ITRP_84,REG_BASE_OIC_ITRP, (0x84),INT_CLEAR) // 22 Bit, 22'h0, W1C
#define OIC_ITRP_INT_MASK _bm(_OIC_ITRP_104,REG_BASE_OIC_ITRP, (0x104),INT_MASK) // 22 Bit, 22'h0, RW
...
#define IR_ADDR _bm(_IR_2,REG_BASE_IR, (2<<3),ADDR) // 8 Bit, 8'h0, R
#define IR_DAT _bm(_IR_2,REG_BASE_IR, (2<<3),DAT) // 8 Bit, 8'h0, R
_regs_ BF_6(UINT _rev0 : 24, UINT OMC_PDONE : 1 ,UINT OMC_PACTIVE : 1 ,UINT OMC_PDENY : 1 ,UINT OMC_PACCEPT :1 ,UINT OMC_DFS_SET : 4 ) _rege_ _SYS_66;
#define SYS_OMC_PDONE _bm(_SYS_66,REG_BASE_SYS, (66<<3),OMC_PDONE) // 1 Bit, 1'h0, R
#define SYS_OMC_PACTIVE _bm(_SYS_66,REG_BASE_SYS, (66<<3),OMC_PACTIVE) // 1 Bit, 1'h0, R
#define SYS_OMC_PDENY _bm(_SYS_66,REG_BASE_SYS, (66<<3),OMC_PDENY) // 1 Bit, 1'h0, R
#define SYS_OMC_PACCEPT _bm(_SYS_66,REG_BASE_SYS, (66<<3),OMC_PACCEPT) // 1 Bit, 1'h0, R
#define SYS_OMC_DFS_SET _bm(_SYS_66,REG_BASE_SYS, (66<<3),OMC_DFS_SET) // 4 Bit, 4'h0, W
_regs_ BF_13(UINT _rev0 : 20, UINT OIC_EVEMON_START_6 : 1 ,UINT OIC_EVEMON_START_5 : 1 ,UINT OIC_EVEMON_START_4 : 1 ,UINT OIC_EVEMON_START_3 : 1 ,UINT OIC_EVEMON_START_2 : 1 ,UINT OIC_EVEMON_START_1 : 1 ,UINT OIC_EVEMON_START_0 : 1 ,UINT OIC_CK_GATE_OFF : 1 ,UINT OIC_CS_DISABLE_RDI : 1 ,UINT OIC_CS_INORDER_RESP2 : 1 ,UINT OIC_CS_INORDER_RESP1 : 1 ,UINT OIC_CS_INORDER_RESP0 : 1 ) _rege_ _SYS_65;
#define SYS_OIC_EVEMON_START_6 _bm(_SYS_65,REG_BASE_SYS, (65<<3),OIC_EVEMON_START_6) // 1 Bit, 1'h0, RW
#define SYS_OIC_EVEMON_START_5 _bm(_SYS_65,REG_BASE_SYS, (65<<3),OIC_EVEMON_START_5) // 1 Bit, 1'h0, RW
#define SYS_OIC_EVEMON_START_4 _bm(_SYS_65,REG_BASE_SYS, (65<<3),OIC_EVEMON_START_4) // 1 Bit, 1'h0, RW
#define SYS_OIC_EVEMON_START_3 _bm(_SYS_65,REG_BASE_SYS, (65<<3),OIC_EVEMON_START_3) // 1 Bit, 1'h0, RW
#define SYS_OIC_EVEMON_START_2 _bm(_SYS_65,REG_BASE_SYS, (65<<3),OIC_EVEMON_START_2) // 1 Bit, 1'h0, RW
#define SYS_OIC_EVEMON_START_1 _bm(_SYS_65,REG_BASE_SYS, (65<<3),OIC_EVEMON_START_1) // 1 Bit, 1'h0, RW
#define SYS_OIC_EVEMON_START_0 _bm(_SYS_65,REG_BASE_SYS, (65<<3),OIC_EVEMON_START_0) // 1 Bit, 1'h0, RW
#define SYS_OIC_CK_GATE_OFF _bm(_SYS_65,REG_BASE_SYS, (65<<3),OIC_CK_GATE_OFF) // 1 Bit, 1'h1, RW
